        ...
        <FormContent>
          ...
          <ButtonContainer>
            ...
            <GoogleSignIn onClick={handleGoogleSignIn}>
              ...
              </svg> Continue with Google </GoogleSignIn>
          </ButtonContainer>
          <RouterLink to="/signup" style={{ color: "#000", fontSize: "0.85rem", fontWeight: "700", textAlign: "right", textDecoration: "underline", padding: "0.6rem 0.2rem", marginTop: "1rem"}}> Sign up for New Account</RouterLink>
        </FormContent>
      </Form>
    </AuthenticationSection>
  );
